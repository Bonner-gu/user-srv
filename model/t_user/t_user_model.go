...
// arModel is a active record design model for table t_user operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of t_user.
	Table = "t_user"
	// Model is the model object of t_user.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table t_user.
	Columns = struct {
		Id         string // 流水id
		Nickname   string // 昵称
		Phone      string // 手机号
